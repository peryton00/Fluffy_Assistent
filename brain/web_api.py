...
# Voice/TTS/STT endpoints moved to routes/voice_routes.py
...
# FTP endpoints moved to routes/ftp_routes.py
# Cluster endpoints moved to routes/cluster_routes.py
# Network endpoints moved to routes/network_routes.py
