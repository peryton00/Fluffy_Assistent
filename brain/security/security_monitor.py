"""
Security Monitor for Fluffy Assistant
Real-time behavioral process threat and anomaly scanner.
"""

import os
import time
from brain.tools import platform_utils
...
class SecurityMonitor:
    ...
    def _update_process_score(self, p, timestamp, ui_active, child_count, persistence_entries):
        ...
        if not ui_active and disk_activity > 5000:
