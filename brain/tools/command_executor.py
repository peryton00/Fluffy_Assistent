...
# Safe imports for both direct execution and package imports
try:
...
class CommandExecutor:
    ...
    def execute_multi_step(self, commands: list, validator) -> Dict[str, Any]:
        ...
        for i, cmd in enumerate(commands):
            ...
            if getattr(cmd, 'intent', None) == Intent.OPEN_APP and i < len(commands) - 1:
