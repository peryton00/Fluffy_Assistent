...
'''
            ...
            # Auto-register in registry for hot-reload
            try:
                ...
                if loader.register_extension(intent_name, registry_metadata):
                    print(f"[ExtensionCreator] ✓ Registered in registry - ready to use immediately!")
                else:
                    print(f"[ExtensionCreator] ⚠ Extension created but registration failed - restart may be needed")
            except Exception as e:
                print(f"[ExtensionCreator] ⚠ Extension created but auto-registration failed: {e}")
                print(f"[ExtensionCreator] Extension will load on next restart")
