"""
Telemetry Memory Manager for Fluffy Assistant
Tracks rolling system and process CPU/RAM metrics for trend analysis and leak detection.
"""
...
class BrainMemory:
    """Tracks rolling history of system and process statistics."""
